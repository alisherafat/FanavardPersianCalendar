...
/**
 * this adapter represents the days which are inside a month
 */
        ...
        if (!isPositionHeader(position)) {
            if (position - 7 - firstDayDayOfWeek >= 0) {
                ...
                if (days.get(position - 7 - firstDayDayOfWeek).isHoliday()) {
                    ...
                    holder.num.setTextColor(ContextCompat.getColor(context, R.color.day));
                }
                ...
                if (position == selectedDay) {
                    ...
                    if (days.get(position - 7 - firstDayDayOfWeek).isHoliday()) {
                        holder.selectDay.setBackgroundColor(ContextCompat.getColor(context, R.color.select_holiday_background));
                    }
                    holder.num.setTextColor(ContextCompat.getColor(context, R.color.select_day));
                } else {
