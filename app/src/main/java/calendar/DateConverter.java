...
public final class DateConverter {
    ...
    public static IslamicDate gregorianToIslamic(GregorianDate civil, int offset) {
        return jdnToIslamic(civilToJdn(civil) + offset);
    }

    public static long civilToJdn(GregorianDate civil) {
    ...
    public static PersianDate civilToPersian(GregorianDate civil) {
    ...
    public static GregorianDate islamicToCivil(IslamicDate islamic) {
    ...
    public static GregorianDate jdnToCivil(long jdn) {
    ...
    public static IslamicDate jdnToIslamic(long jd) {
        ...
        GregorianDate civil = jdnToCivil(jd);
    ...
    public static GregorianDate jdnToJulian(long jdn) {
        long j = jdn + 1402;
        long k = ((j - 1) / 1461);
        long l = j - 1461 * k;
    ...
    public static GregorianDate persianToGregorian(PersianDate persian) {
